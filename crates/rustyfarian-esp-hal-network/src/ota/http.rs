//! Strict HTTP/1.1 GET client — internal transport for `rustyfarian-esp-hal-network`.
//!
//! This HTTP client is an implementation detail of `rustyfarian-esp-hal-network`
