...
use super::{LoraConfig, LoraRadio};
use heapless::Vec;
...
pub struct LorawanSessionData {
    ...
    pub rx1_delay_s: u8,
    /// [`Region`][super::config::Region] enum discriminant — needed to reconstruct
...
mod tests {
    ...
    mod with_mock {
        use super::*;
        use crate::lora::config::Region;
        use crate::lora::mock::MockLoraRadio;
