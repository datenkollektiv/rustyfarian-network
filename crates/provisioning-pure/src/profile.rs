...
//! [`ProvisioningConfig`](crate::ProvisioningConfig).
...
pub struct MqttFields {
    ...
    pub(crate) client_id:
        Option<heapless::String<{ rustyfarian_network_pure::mqtt::CLIENT_ID_MAX_LEN }>>,
}
...
impl MqttFields {
    ...
    /// must truncate.
    ///
    /// [`DEVICE_NAME_MAX_LEN`]: crate::DEVICE_NAME_MAX_LEN
