...
- [ ] Phase 1 — store module (host-tested) — in progress 2026-06-15
- [ ] Phase 2 — portal (edge-net wiring + templates) — substrate spike gate cleared 2026-06-15 with the §3 hand-rolled fallback (DHCP + DNS catch-all + HTTP server behind the `provisioning-spike` Cargo feature in `rustyfarian-esp-hal-wifi`); portal logic, template wiring, security-checklist conformance, and promotion into `rustyfarian-esp-hal-provisioning` remain
- [ ] Phase 3 — examples + build routing + justfile
